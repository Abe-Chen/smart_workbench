...
class AssistantRequestRouter {
  static AssistantRequestPlan planFor({
    ...
    return AssistantRequestPlan(
      ...
      intent: _classifyIntent(normalized),
...
final RegExp _localActionPattern = RegExp(
  r'(帮我|给我|替我|把|新增|创建|新建|添加|修改|调整|推迟|提前|删除|取消|完成|标记).{0,12}(任务|待办|日程|提醒|会议|安排)',
);
...
final RegExp _scheduleWritePattern = RegExp(
  r'(帮我|给我|替我|把|新增|创建|新建|添加|加|修改|调整|推迟|提前|删除|取消|完成|标记).{0,12}(任务|待办|日程|会议|安排)',
);
